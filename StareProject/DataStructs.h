...
struct sentenceRanking
{
	...
	float certainty;	  // The certainty that a certain sentence is the particular style listed.

	sentenceRanking(int SentenceID, int FoundDocumentID, int FoundSentenceID, float Certainty)
	{
